...
- (IBAction)imageButton1Clicked
{
	[self buttonClicked:self.button1];
}

- (IBAction)imageButton2Clicked
{
	[self buttonClicked:self.button2];
}

- (IBAction)imageButton3Clicked
{
	[self buttonClicked:self.button3];
}

- (IBAction)imageButton4Clicked
{
	[self buttonClicked:self.button4];
}

- (IBAction)imageButton5Clicked
{
	[self buttonClicked:self.button5];
}

- (IBAction)imageButton6Clicked
{
	[self buttonClicked:self.button6];
}

- (IBAction)imageButton7Clicked
{
	[self buttonClicked:self.button7];
}

- (IBAction)imageButton8Clicked
{
	[self buttonClicked:self.button8];
}

- (IBAction)imageButton9Clicked
{
	[self buttonClicked:self.button9];
}

- (IBAction)imageButton10Clicked
{
	[self buttonClicked:self.button10];
}

- (IBAction)imageButton11Clicked
{
	[self buttonClicked:self.button11];
}

- (IBAction)imageButton12Clicked
{
	[self buttonClicked:self.button12];
}

- (IBAction)imageButton13Clicked
{
	[self buttonClicked:self.button13];
}

- (IBAction)imageButton14Clicked
{
	[self buttonClicked:self.button14];
}

- (IBAction)imageButton15Clicked
{
	[self buttonClicked:self.button15];
}

- (IBAction)imageButton16Clicked
{
	[self buttonClicked:self.button16];
}

- (IBAction)imageButton17Clicked
{
	[self buttonClicked:self.button17];
}

- (IBAction)imageButton18Clicked
{
	[self buttonClicked:self.button18];
}

- (IBAction)imageButton19Clicked
{
	[self buttonClicked:self.button19];
}

- (IBAction)imageButton20Clicked
{
	[self buttonClicked:self.button20];
}

- (IBAction)imageButton21Clicked
{
	[self buttonClicked:self.button21];
}

- (IBAction)imageButton22Clicked
{
	[self buttonClicked:self.button22];
}

- (IBAction)imageButton23Clicked
{
	[self buttonClicked:self.button23];
}

- (IBAction)imageButton24Clicked
{
	[self buttonClicked:self.button24];
}

- (IBAction)imageButton25Clicked
{
	[self buttonClicked:self.button25];
}

- (IBAction)imageButton26Clicked
{
	[self buttonClicked:self.button26];
}

- (IBAction)imageButton27Clicked
{
	[self buttonClicked:self.button27];
}

- (IBAction)imageButton28Clicked
{
	[self buttonClicked:self.button28];
}

- (IBAction)imageButton29Clicked
{
	[self buttonClicked:self.button29];
}

- (IBAction)imageButton30Clicked
{
	[self buttonClicked:self.button30];
}

- (IBAction)imageButton31Clicked
{
	[self buttonClicked:self.button31];
}

- (IBAction)imageButton32Clicked
{
	[self buttonClicked:self.button32];
}

- (IBAction)imageButton33Clicked
{
	[self buttonClicked:self.button33];
}

- (IBAction)imageButton34Clicked
{
	[self buttonClicked:self.button34];
}

- (IBAction)imageButton35Clicked
{
	[self buttonClicked:self.button35];
}

- (IBAction)imageButton36Clicked
{
	[self buttonClicked:self.button36];
}
